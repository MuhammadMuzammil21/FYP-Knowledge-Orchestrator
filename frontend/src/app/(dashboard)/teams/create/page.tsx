                ...
                <div className="p-6">
                    <form onSubmit={onSubmit} className="space-y-6">
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="slug">Team URL <span className="text-destructive">*</span></Label>
                                <Input
                                    id="slug"
                                    placeholder="e.g. acme-corp"
                                    required
                                ...
                                <p className="text-xs text-muted-foreground mt-1">
                                    Your team will be accessed at harbaat.ai/teams/<span className="font-semibold text-foreground">{slug || '...'}</span>
                                </p>
                            </div>
                        ...
                        <Button type="submit" className="w-full" disabled={createTeam.isPending || !name || !slug}>
