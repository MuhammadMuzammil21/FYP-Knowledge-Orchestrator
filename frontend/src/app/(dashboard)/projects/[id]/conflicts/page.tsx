      ...
      {isLoading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <Card className="p-4 border-accent/30 bg-accent/5 dark:bg-accent/5 dark:border-accent/20 shadow-sm">
              ...
              <div className="mt-1 text-3xl font-bold text-accent">{resolvedConflicts.length}</div>
            </Card>
          </div>
                      ...
                      <div className="flex-1">
                        ...
                        {conflict.resolution_note && (
                          <div className="mt-2 rounded bg-accent/10 p-3">
                            ...
                            <p className="text-sm text-foreground">{conflict.resolution_note}</p>
                          </div>
                        )}
                      </div>
                    </div>
        ...
        <div className="flex h-96 items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-muted-foreground/70">No conflicts detected in this project</p>
          </div>
        </div>
      )}
