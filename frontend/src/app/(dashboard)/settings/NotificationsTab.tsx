        ...
        <div className="space-y-4">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Choose which events trigger notifications in HarBaat AI
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                    <PreferenceRow
            ...
            <Card>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="flex items-start gap-2 rounded-md bg-muted/50 p-3 text-sm text-muted-foreground">
                        ...
                        <p>
                            Email delivery is currently being set up. Toggling this preference will
                            take effect once the email service is enabled.
                        </p>
                    </div>
                </CardContent>
            </Card>
