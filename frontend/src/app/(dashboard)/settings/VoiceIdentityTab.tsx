...
import {
  useVoiceIdentity,
  useRegisterVoiceIdentity,
  useDeleteVoiceIdentity,
} from '@/hooks/useVoiceIdentity';
          ...
          <>
            ...
            {!hasVoice ? (
              <div className="space-y-4">
                <p className="text-sm">
                  Record a short 5-10 second clip of you speaking naturally. This audio is securely
                  encrypted and used exclusively for speaker identification within your team.
                </p>
