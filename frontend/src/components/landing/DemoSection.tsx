      ...
      <div className="p-4 space-y-4">
        <div>
          ...
          <div className="space-y-2">
            ...
            <Badge className="bg-primary/10 text-primary dark:bg-primary/20 dark:text-primary border-transparent text-xs ml-2">
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <Badge className="bg-accent/15 text-accent dark:bg-accent/20 border-transparent text-xs ml-2">
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <Badge className="bg-accent/10 text-accent dark:bg-accent/15 border-transparent text-xs ml-2">
              Developer preview
            </Badge>
          </div>
        </div>
