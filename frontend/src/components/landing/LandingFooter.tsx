    ...
    <footer className="bg-background pt-16 pb-8 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          {/* Brand col */}
          <div className="lg:col-span-1 xs:col-span-1 sm:col-span-2">
          ...
          {Object.entries(footerLinks).map(([group, links]) => (
            <div key={group}>
              <h3 className="font-display text-sm font-600 tracking-widest uppercase text-muted-foreground mb-4">{group}</h3>
