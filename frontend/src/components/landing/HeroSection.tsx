  ...
  return (
    <div className="relative">
      ...
      <section className="overflow-hidden bg-background">
        <div className="relative mx-auto max-w-7xl px-6 py-16 sm:py-20 md:py-24 lg:py-32">
          <div className="relative z-10 mx-auto max-w-3xl text-center">
            <h1 className="text-balance text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-display font-bold tracking-tight text-foreground hero-headline animate-hero-headline">
            ...
            <div className="animate-hero-cta mt-8 flex flex-col w-full sm:w-auto sm:flex-row sm:justify-center gap-4">
            ...
            {/* Trust micro-copy */}
            <div className="mt-8 text-sm text-muted-foreground flex flex-wrap items-center justify-center gap-x-3 gap-y-1">
        ...
        <div className="mx-auto mt-4 max-w-6xl px-6 pb-32">
          ...
          <div className="w-full shadow-2xl shadow-primary/20 rounded-2xl border border-border/60 bg-background overflow-hidden flex flex-col md:flex-row h-auto md:h-[600px] lg:h-[700px] xl:h-[750px] text-left">
            
            {/* Sidebar */}
            <div className="w-full md:w-64 border-r border-border/20 bg-muted/20 p-4 hidden md:flex flex-col">
              ...
              <div className="space-y-6 flex-1 overflow-y-auto pr-2">
                <div>
                  <div className="text-[10px] font-semibold text-muted-foreground mb-2 px-2 flex justify-between items-center tracking-wider uppercase">
                    Personal Workspace
                ...
                <div>
                  <div className="text-[10px] font-semibold text-muted-foreground mb-2 px-2 tracking-wider uppercase">ACCOUNT</div>
                  <div className="space-y-1">
                    <div className="px-3 py-2 rounded-lg text-muted-foreground hover:bg-muted/50 text-sm font-medium cursor-pointer flex items-center gap-2.5 transition-colors">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-card border border-border/50 rounded-2xl p-6 shadow-sm">
                      <div className="text-[10px] font-semibold text-muted-foreground tracking-wider mb-6 uppercase">How it works</div>
                    ...
                    {/* What you get */}
                    <div className="bg-card border border-border/50 rounded-2xl p-6 shadow-sm">
                      <div className="text-[10px] font-semibold text-muted-foreground tracking-wider mb-5 uppercase">What you get</div>
                    ...
                    <div className="bg-card border border-border/50 rounded-2xl p-6 shadow-sm flex flex-col h-full">
                      ...
                      <div className="space-y-5 flex-1">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-muted-foreground mt-2">Leave empty to auto-detect the dominant language</p>
                        </div>
                        ...
                        <div className="pt-1">
                          <div className="w-full rounded-xl border border-border/50 bg-muted/50 px-3.5 py-3 text-[13px] font-medium text-foreground flex justify-between items-center cursor-pointer">
                            <div className="flex items-center gap-2">
                              Speaker configuration <span className="text-[10px] bg-background border border-border px-1.5 py-0.5 rounded font-normal text-muted-foreground">Optional</span>
                            </div>
                            <ChevronDown className="w-4 h-4 text-muted-foreground" />
                          </div>
                        </div>
                        ...
                        <div className="pt-3">
                          ...
                          <p className="text-[10px] text-muted-foreground mt-3 text-center">Supported formats: MP3, WAV, M4A, OGG • Maximum 100MB</p>
                        </div>
                      </div>
